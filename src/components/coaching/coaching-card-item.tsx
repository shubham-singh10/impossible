...
import { data } from '../../components/coaching/coaching.data';
              ...
              <Box sx={{
                ...
                <List component="nav">
                  <ListItem button>
                    ...
                    <ListItemText primary="Life Coaching & NLP Coaching" primaryTypographyProps={{
              ...
              <Box sx={{
                ...
                <List component="nav">
                  <ListItem button>
                    ...
                    <ListItemText primary="Corporate Performance & Executive Coaching" primaryTypographyProps={{
                      style: { whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis', textTransform: "uppercase" },
                    }} />
                  </ListItem>
                </List>
              ...
              <Box sx={{
                ...
                <List component="nav">
                  <ListItem button>
                    ...
                    <ListItemText primary="Business Coaching" primaryTypographyProps={{
                      style: { whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis', textTransform: "uppercase" },
                    }} />
                  </ListItem>
                </List>
...
export default CoachingCardItem;
